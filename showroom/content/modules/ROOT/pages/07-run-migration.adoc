...
image::scaffolder-steps.svg[Scaffolder pipeline: template, Gitea, catalog, Argo CD, Mailpit]
...
image::resource-mapping.svg[Mapping from 3scale concepts to Connectivity Link resources]
