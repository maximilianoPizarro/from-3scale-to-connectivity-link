...
| Recurso | URL |
|---------|-----|
| **Frontend** | [neuralbank.apps.cluster-cq9fp.dynamic.redhatworkshops.io](https://neuralbank.apps.cluster-cq9fp.dynamic.redhatworkshops.io) |
| **Swagger UI** | [neuralbank.apps.cluster-cq9fp.dynamic.redhatworkshops.io/q/swagger-ui](https://neuralbank.apps.cluster-cq9fp.dynamic.redhatworkshops.io/q/swagger-ui) |
| **API Base** | `https://neuralbank.apps.cluster-cq9fp.dynamic.redhatworkshops.io/api/v1/customers` |
...
| **URL del realm** | `https://rhbk.apps.cluster-cq9fp.dynamic.redhatworkshops.io/realms/neuralbank` |
...
curl -s -H "Authorization: Bearer $TOKEN" \
  https://neuralbank.apps.cluster-cq9fp.dynamic.redhatworkshops.io/api/v1/customers/1 | python3 -m json.tool

# Resumen del cliente
curl -s -H "Authorization: Bearer $TOKEN" \
  https://neuralbank.apps.cluster-cq9fp.dynamic.redhatworkshops.io/api/v1/customers/1/summary | python3 -m json.tool
```
