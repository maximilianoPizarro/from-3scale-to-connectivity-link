...
| Recurso | URL |
|---------|-----|
| **Frontend** | [neuralbank.apps.cluster-2fjv7.dynamic.redhatworkshops.io](https://neuralbank.apps.cluster-2fjv7.dynamic.redhatworkshops.io) |
| **Swagger UI** | [neuralbank.apps.cluster-2fjv7.dynamic.redhatworkshops.io/q/swagger-ui](https://neuralbank.apps.cluster-2fjv7.dynamic.redhatworkshops.io/q/swagger-ui) |
| **API Base** | `https://neuralbank.apps.cluster-2fjv7.dynamic.redhatworkshops.io/api/v1/customers` |
| **Grafana** | [grafana-observability.apps.cluster-2fjv7.dynamic.redhatworkshops.io](https://grafana-observability.apps.cluster-2fjv7.dynamic.redhatworkshops.io) |
...
| **URL del realm** | `https://rhbk.apps.cluster-2fjv7.dynamic.redhatworkshops.io/realms/neuralbank` |
...
TOKEN=$(curl -s -X POST \
  "https://rhbk.apps.cluster-2fjv7.dynamic.redhatworkshops.io/realms/neuralbank/protocol/openid-connect/token" \
...
curl -s -H "Authorization: Bearer $TOKEN" \
  https://neuralbank.apps.cluster-2fjv7.dynamic.redhatworkshops.io/api/v1/customers | python3 -m json.tool

# Obtener cliente por ID
curl -s -H "Authorization: Bearer $TOKEN" \
  https://neuralbank.apps.cluster-2fjv7.dynamic.redhatworkshops.io/api/v1/customers/1 | python3 -m json.tool

# Resumen del cliente
curl -s -H "Authorization: Bearer $TOKEN" \
  https://neuralbank.apps.cluster-2fjv7.dynamic.redhatworkshops.io/api/v1/customers/1/summary | python3 -m json.tool
```
