...
| Recurso | URL |
|---------|-----|
| **Frontend** | [neuralbank.apps.cluster-lfm7v.dynamic.redhatworkshops.io](https://neuralbank.apps.cluster-lfm7v.dynamic.redhatworkshops.io) |
| **Swagger UI** | [neuralbank.apps.cluster-lfm7v.dynamic.redhatworkshops.io/q/swagger-ui](https://neuralbank.apps.cluster-lfm7v.dynamic.redhatworkshops.io/q/swagger-ui) |
| **API Base** | `https://neuralbank.apps.cluster-lfm7v.dynamic.redhatworkshops.io/api/v1/customers` |
| **Grafana** | [grafana-observability.apps.cluster-lfm7v.dynamic.redhatworkshops.io](https://grafana-observability.apps.cluster-lfm7v.dynamic.redhatworkshops.io) |
...
| **URL del realm** | `https://rhbk.apps.cluster-lfm7v.dynamic.redhatworkshops.io/realms/neuralbank` |
...
curl -s -H "Authorization: Bearer $TOKEN" \
  https://neuralbank.apps.cluster-lfm7v.dynamic.redhatworkshops.io/api/v1/customers | python3 -m json.tool

# Obtener cliente por ID
curl -s -H "Authorization: Bearer $TOKEN" \
  https://neuralbank.apps.cluster-lfm7v.dynamic.redhatworkshops.io/api/v1/customers/1 | python3 -m json.tool

# Resumen del cliente
curl -s -H "Authorization: Bearer $TOKEN" \
  https://neuralbank.apps.cluster-lfm7v.dynamic.redhatworkshops.io/api/v1/customers/1/summary | python3 -m json.tool
```
