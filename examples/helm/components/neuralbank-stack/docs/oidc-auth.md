...
| Campo | Valor |
|-------|-------|
| **Realm URL** | `https://rhbk.apps.cluster.example.com/realms/neuralbank` |
| **Well-known** | `https://rhbk.apps.cluster.example.com/realms/neuralbank/.well-known/openid-configuration` |
...
1. Navegar a `https://neuralbank.apps.cluster.example.com`
...
```bash
curl -v https://neuralbank.apps.cluster.example.com/api/v1/customers 2>&1 | grep "< HTTP\|< location"
```
