...
```
https://neuralbank.apps.cluster-2fjv7.dynamic.redhatworkshops.io
```
...
```bash
curl -s -H "Authorization: Bearer $TOKEN" \
  "https://neuralbank.apps.cluster-2fjv7.dynamic.redhatworkshops.io/api/v1/customers?tipoCliente=PERSONAL&ciudad=Buenos+Aires&page=0&size=5" \
  | python3 -m json.tool
```
...
```bash
curl -s -H "Authorization: Bearer $TOKEN" \
  "https://neuralbank.apps.cluster-2fjv7.dynamic.redhatworkshops.io/api/v1/customers/1/credit-score" \
  | python3 -m json.tool
```
...
```bash
curl -s -H "Authorization: Bearer $TOKEN" \
  "https://neuralbank.apps.cluster-2fjv7.dynamic.redhatworkshops.io/api/v1/customers/1/summary" \
  | python3 -m json.tool
```
...
**URL**: [https://neuralbank.apps.cluster-2fjv7.dynamic.redhatworkshops.io/q/swagger-ui](https://neuralbank.apps.cluster-2fjv7.dynamic.redhatworkshops.io/q/swagger-ui)
...
```bash
curl -s -H "Authorization: Bearer $TOKEN" \
  https://neuralbank.apps.cluster-2fjv7.dynamic.redhatworkshops.io/q/openapi
```
