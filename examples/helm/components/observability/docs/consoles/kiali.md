...
<iframe src="https://kiali-openshift-cluster-observability-operator.apps.cluster-cq9fp.dynamic.redhatworkshops.io/kiali/" width="100%" height="900" frameborder="0" style="border:1px solid #ddd; border-radius:8px;"></iframe>

[Abrir Kiali :material-open-in-new:](https://kiali-openshift-cluster-observability-operator.apps.cluster-cq9fp.dynamic.redhatworkshops.io){ .md-button }
