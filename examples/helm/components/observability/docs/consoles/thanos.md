...
<iframe src="https://thanos-querier.apps.cluster-cq9fp.dynamic.redhatworkshops.io/" width="100%" height="900" frameborder="0" style="border:1px solid #ddd; border-radius:8px;"></iframe>

[Abrir Thanos Querier :material-open-in-new:](https://thanos-querier.apps.cluster-cq9fp.dynamic.redhatworkshops.io){ .md-button }
