...
| Recurso | URL |
|---------|-----|
| **Swagger UI** | [nfl-wallet.apps.cluster-qbg7r.dynamic.redhatworkshops.io/q/swagger-ui](https://nfl-wallet.apps.cluster-qbg7r.dynamic.redhatworkshops.io/q/swagger-ui) |
| **API Base** | `https://nfl-wallet.apps.cluster-qbg7r.dynamic.redhatworkshops.io/api/v1/customers` |
...
# Resumen del cliente
curl -H "X-API-Key: nfl-wallet-demo-key-2024" \
  https://nfl-wallet.apps.cluster-qbg7r.dynamic.redhatworkshops.io/api/v1/customers/1/summary
```
