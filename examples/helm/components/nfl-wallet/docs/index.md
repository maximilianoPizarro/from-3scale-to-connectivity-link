...
| Recurso | URL |
|---------|-----|
| **Swagger UI** | [nfl-wallet.apps.cluster-4wrc6.dynamic.redhatworkshops.io/q/swagger-ui](https://nfl-wallet.apps.cluster-4wrc6.dynamic.redhatworkshops.io/q/swagger-ui) |
| **API Base** | `https://nfl-wallet.apps.cluster-4wrc6.dynamic.redhatworkshops.io/api/v1/customers` |
...
curl -H "X-API-Key: nfl-wallet-demo-key-2024" \
  https://nfl-wallet.apps.cluster-4wrc6.dynamic.redhatworkshops.io/api/v1/customers

# Obtener cliente por ID
curl -H "X-API-Key: nfl-wallet-demo-key-2024" \
  https://nfl-wallet.apps.cluster-4wrc6.dynamic.redhatworkshops.io/api/v1/customers/1
...
curl -H "X-API-Key: nfl-wallet-demo-key-2024" \
  https://nfl-wallet.apps.cluster-4wrc6.dynamic.redhatworkshops.io/api/v1/customers/1/credit-score

# Resumen del cliente
curl -H "X-API-Key: nfl-wallet-demo-key-2024" \
  https://nfl-wallet.apps.cluster-4wrc6.dynamic.redhatworkshops.io/api/v1/customers/1/summary
```
