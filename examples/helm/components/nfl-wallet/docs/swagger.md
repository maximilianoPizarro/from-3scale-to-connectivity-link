...
**URL**: [https://nfl-wallet.apps.cluster-qbg7r.dynamic.redhatworkshops.io/q/swagger-ui](https://nfl-wallet.apps.cluster-qbg7r.dynamic.redhatworkshops.io/q/swagger-ui)
...
curl -H "X-API-Key: nfl-wallet-demo-key-2024" \
  https://nfl-wallet.apps.cluster-qbg7r.dynamic.redhatworkshops.io/q/openapi
```
