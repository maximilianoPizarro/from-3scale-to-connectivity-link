...
```bash
curl -s https://nfl-wallet.apps.cluster-94mvp.dynamic.redhatworkshops.io/api/v1/customers
```
...
```
https://nfl-wallet.apps.cluster-94mvp.dynamic.redhatworkshops.io/q/swagger-ui
```
