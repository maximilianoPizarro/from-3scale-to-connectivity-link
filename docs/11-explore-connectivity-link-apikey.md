...
```bash
curl -s https://nfl-wallet.apps.cluster-h4jtk.dynamic.redhatworkshops.io/api/v1/customers
```
...
```
https://nfl-wallet.apps.cluster-h4jtk.dynamic.redhatworkshops.io/q/swagger-ui
```
