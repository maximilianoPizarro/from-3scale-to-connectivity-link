...
```bash
curl -s https://nfl-wallet.apps.cluster-lfm7v.dynamic2.redhatworkshops.io/api/v1/customers
```
...
```
https://nfl-wallet.apps.cluster-lfm7v.dynamic2.redhatworkshops.io/q/swagger-ui
```
