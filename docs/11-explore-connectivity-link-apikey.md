...
```bash
curl -s https://nfl-wallet.apps.cluster-2fjv7.dynamic.redhatworkshops.io/api/v1/customers
```
...
```
https://nfl-wallet.apps.cluster-2fjv7.dynamic.redhatworkshops.io/q/swagger-ui
```
