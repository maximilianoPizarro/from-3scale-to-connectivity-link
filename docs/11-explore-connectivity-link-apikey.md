...
```bash
curl -s https://nfl-wallet.apps.cluster-4wrc6.dynamic.redhatworkshops.io/api/v1/customers
```
...
```
https://nfl-wallet.apps.cluster-4wrc6.dynamic.redhatworkshops.io/q/swagger-ui
```
