...
```bash
curl -s https://nfl-wallet.apps.cluster-cq9fp.dynamic.redhatworkshops.io/api/v1/customers
```
...
```
https://nfl-wallet.apps.cluster-cq9fp.dynamic.redhatworkshops.io/q/swagger-ui
```
