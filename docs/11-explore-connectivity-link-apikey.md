...
```bash
curl -s https://nfl-wallet.apps.cluster-zgksw.dynamic.redhatworkshops.io/api/v1/customers
```
...
```
https://nfl-wallet.apps.cluster-zgksw.dynamic.redhatworkshops.io/q/swagger-ui
```
