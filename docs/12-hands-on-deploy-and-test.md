...
1. Log in to **Developer Hub**: `https://backstage-developer-hub-developer-hub.apps.cluster-h4jtk.dynamic.redhatworkshops.io`
...
```
https://openshift-gitops-server-openshift-gitops.apps.cluster-h4jtk.dynamic.redhatworkshops.io
```
