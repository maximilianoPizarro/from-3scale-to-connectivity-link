...
1. Log in to **Developer Hub**: `https://backstage-developer-hub-developer-hub.apps.cluster-2fjv7.dynamic.redhatworkshops.io`
...
```
https://openshift-gitops-server-openshift-gitops.apps.cluster-2fjv7.dynamic.redhatworkshops.io
```
