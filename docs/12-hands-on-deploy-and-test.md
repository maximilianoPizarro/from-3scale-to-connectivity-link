...
1. Log in to **Developer Hub**: `https://backstage-developer-hub-developer-hub.apps.cluster-4wrc6.dynamic.redhatworkshops.io`
...
```
https://openshift-gitops-server-openshift-gitops.apps.cluster-4wrc6.dynamic.redhatworkshops.io
```
